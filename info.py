...
# Bot information
API_ID = environ.get('API_ID', '28244492')
if len(API_ID) == 0:
...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '7325908672:AAGQ2FFlMp7kgj2cCqNlZGjfw60iJWf73hA')
if len(BOT_TOKEN) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '6969742016')
if len(ADMINS) == 0:
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002023912700')
